...
const Card = ({ service }: { service: IServiceProp }) => {
    return (
        <div className=" group  flex-1 w-[250px]  md:w-[350px]  h-96 md:h-80 p-2 sm:p-6 bg-white/10 backdrop-blur-md rounded-2xl  hover:shadow shadow-[#26a0da]  flex flex-col justify-between">
            <div>
