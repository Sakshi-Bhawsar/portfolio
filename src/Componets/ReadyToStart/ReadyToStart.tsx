    ...
    return(
         <div className=" animate__animated animate__fadeInUp py-14 mt-10  w-full text-white text-center">
             ...
             <div className=" flex flex-col sm:flex-row gap-6 justify-center items-center">
                <button className="button px-6 py-2 rounded-lg cursor-pointer w-fit ">Get In Touch</button>
                <button className=" border-2 border-[#06b6d4] px-6 py-2 rounded-lg cursor-pointer hover:bg-[#222e46] hover:shadow-md active:text-gray-300  w-fit">View Resume</button>
             </div>
         </div>
    )
}
